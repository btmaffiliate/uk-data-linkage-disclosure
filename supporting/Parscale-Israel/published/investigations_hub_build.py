...
content=[
 ...
 "---",
 H("III. The AI-influence beat"),
 "The bigger frame the Parscale work opened &mdash; bigger than any one person: <strong>the first wave of states buying AI-output shaping.</strong>",
 L("the-first-wave","The First Wave","how states started buying the manipulation of what AI tells you &mdash; the first FARA-disclosed case (Israel/Parscale), the only state peer (Russia&rsquo;s &lsquo;Pravda&rsquo; network), the commercial toolchain, and the platforms&rsquo; silence; with the effectiveness dispute kept in full view."),
 "---",
