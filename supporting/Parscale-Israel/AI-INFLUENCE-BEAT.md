...
*The bigger frame behind the Parscale/Israel story. An OSINT synthesis, June 2026, from three parallel research streams (the full Havas apparatus; the Havas/Bolloré conduit; the global AI-influence landscape), adversarially verified. Tiers: [confirmed] / [reported] / [alleged]. The core stories were broken by others (The Intercept, Sludge, Responsible Statecraft, Marc Owen Jones, Viginum, NewsGuard, DFRLab) — credited throughout; the original contribution here is the **synthesis into a single thesis** and the **whole-apparatus map**.*

---

## The thesis (and why it's original)
...
| Node | FARA # | Owner | $ (disclosed) | Function |
|---|---|---|---|---|
| Clock Tower X | 7649 | Brad Parscale | $6M→$9M; **>$15M received** | AI/SEO content, Gen-Z, Salem; the AI-output-shaping node |
| Show Faith by Works | 7653 | Chad Schnitger | ~$4.1M | geofencing ~303 megachurches (scrapped after backlash) |
| Bridges Partners ("Esther Project") | 7652 | Steinberg/Levi | ~$900K | paid influencers (~$7K/post) |
| Davis Media NY | 7662 | Yoav Davis | undisclosed | social; dual-funded (Havas + Tel Aviv firm) |
| SKDK (Stagwell) | 7552 | Mark Penn | $600K | comms + bot-amplification; **terminated** after backlash |
...
## Part 2b — The operatives: who actually runs the machine

Two operational nodes that the headline coverage skips — both sourced, both with a precise open lead.

**SparkFire Technologies — the persuasion-for-hire vendor.** [confirmed] An Atlanta firm founded **March 2023** by **Jeremy Haile** (CEO) and **Tree McGlown** (President), both alumni of the influencer-marketing startup Sideqik; unfunded. Its product, the **"flywheel,"** is AI persuasion-texting marketed explicitly to **"Political / Government / Advocacy."** It received **>$6M from Clock Tower X for "Direct Engagement"** (the fake-persona "Friends for Peace"/"Partners in Peace" texts; no FARA disclosure on the texts; self-claimed 45% conversion). The original find: per **FEC records (~$641K)** it was already a **conservative-PAC texting vendor before the Israel job** — Never Back Down (pro-DeSantis, $120K), the Heritage-linked Sentinel Action Fund (~$123K), Hardworking Americans ($150K), And Justice for All ($134K), and **First Principles PAC ($200K), tied to Leonard Leo's "Lexington" dark-money network.** *Discipline: the First-Principles→Leo link is a **vendor** relationship — SparkFire texts for many committees — an ecosystem data-point, **not** a Parscale–Leo tie. Only The Intercept had named SparkFire before; this profile is largely original.*

**The Esther Project — the located gap.** [confirmed] A **separate** registrant from Parscale: **Bridges Partners LLC (FARA #7652**, principals Uri Steinberg & Yair Levi), funded via Havas on behalf of Israel's MFA, **up to ~$900K**, paying **14–18 US influencers ~$7K/post.** The central open question — *who are the influencers?* — remains **open, and precisely located:** **not one** has been publicly identified; the only named payees in the filings are two Israeli back-office consultants (Nadav Shtrauchler $15K, Pnina Rezidor $10K). The document that would crack it — **the Bridges FARA supplemental statement** itemizing recipients — **has not been disclosed**; Public Citizen + the Quincy Institute demanded DOJ force it, and **DOJ has not acted.** *Do not name names: the influencers who circulated early (Savetsky, Fischberger) were **explicitly NOT payees** — JTA ran a correction and both denied payment.*
