# Splink / Palantir — MP Pack (definitive)
### Prepared for the Office of Iqbal Mohamed MP · Brandon Myers · brandonmyers.net · June 2026

Read/send in this order:
...
| 03 | **Part 2 — The Evidence & Your Questions** (24 pp) | The MoJ Splink OSINT investigation + ready-to-table follow-up WPQs and FOIs. |

### The discipline that makes it hold
- Every claim is tagged **confirmed / inference / unanswered** with a real source URL.
- **The Met/Palantir policing trial (00, 01, 02) and the MoJ/Splink programme (03) are different systems** — kept distinct, never conflated.
- **Contract figures (e.g. £489,999, any split) are reported, not yet confirmed against the primary Contracts Finder/MOPAC record.** They are framed as *questions to put to the Met*, not assertions. Confirm via FOI to the Met + MOPAC and a manual Contracts Finder check before any figure is stated as fact on the record.
- **Intent is never asserted** — whether the structure was deliberate threshold avoidance is *the question to ask*; the law is cited to show the question is legitimate.

Built from public documents only. Not legal advice.
